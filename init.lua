    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Jump to next error
          map('gl', function()
            vim.diagnostic.jump { wrap = true, direction = 'next', count = 1 }
          end, 'Jump to Next Diagnostic')

          -- Jump to next error
          map('gL', function()
            vim.diagnostic.jump { wrap = true, direction = 'prev', count = 1 }
      ...
      local servers = {
        ...
        ts_ls = {
          ...
          --     {
          --       name = '@vue/typescript-plugin',
          --       location = vue_language_server_path, -- vim.fn.stdpath 'data' .. '/mason/packages/vue-language-server/node_modules/@vue/language-server',
          --       languages = { 'vue' },
          --     },
          --   },
          -- },
